  ...
  <body>
    ...
    <header>
      ...
      <div id="header">
        ...
        <!-- 상품 등록 코드 url 경로 수정 필요! -->
        <div>
          <button class="headerBtn" onclick="location.href='/ehr/user/login/login.do'">로그인/회원가입</button>
          <button class="headerBtn" onclick="location.href='/ehr/product_board/post.do'">상품 등록</button>
        </div>
        <!-- 하단 코드들 url 경로 수정 필요! -->
        <div>
          <button class="headerBtn" onclick="location.href='/ehr/user/mypage.do'">마이페이지</button>
      <!-- 로그아웃 버튼 -->
      <button class="headerBtn" id="logoutBtn">로그아웃</button>
    </div>
        ...
        <div class="carousel_wrapper">
          ...
          <div class="carousel_item">
            <div class="kategoryWrap">
              ...
              <img src="/ehr/resources/assets/images/camera.png" alt="카메라" class="kategory camera" />
              <img
                src="/ehr/resources/assets/images/microwave.png"
                alt="전자레인지"
                class="kategory camera"
              />
              <img src="/ehr/resources/assets/images/chair.png" alt="가구/인테리어" class="kategory" />
              <img src="/ehr/resources/assets/images/pot.png" alt="생활/주방" class="kategory" />
              <img src="/ehr/resources/assets/images/toy.png" alt="유아동" class="kategory" />
            </div>
           ...
           <div class="carousel_item">
            <div class="kategoryWrap">
              ...
              <img
                ...
                class="kategory"
              />
              <img src="/ehr/resources/assets/images/beauty.png" alt="뷰티/미용" class="kategory" />
              <img
                src="/ehr/resources/assets/images/sports.png"
                alt="스포츠/레저"
                class="kategory"
              />
            ...
            <div class="kategoryWrap kategoryH">
              <a href="#"><strong>여성패션/잡화</strong></a>
          ...
          <div class="carousel_item">
            <div class="kategoryWrap">
              ...
              <img
              src="/ehr/resources/assets/images/hobby.png"
              alt="취미/게임/음반"
              class="kategory"
            />

              <img
                src="/ehr/resources/assets/images/Book.png"
                alt="도서"
                class="kategory"
              />
              <img
                src="/ehr/resources/assets/images/ticket.png"
                alt="티켓/교환권"
                class="kategory"
              />
              <img src="/ehr/resources/assets/images/food.png" alt="가공식품" class="kategory" />
              <img
                src="/ehr/resources/assets/images/health.png"
                alt="건강기능식품"
                class="kategory"
              />
          ...
          <div class="carousel_item">
            <div class="kategoryWrap">
              ...
              <img
              src="/ehr/resources/assets/images/pet.png"
              alt="반려동물용품"
              class="kategory"
            />

              <img
                src="/ehr/resources/assets/images/plant.png"
                alt="식물"
                class="kategory"
              />
              <img
                src="/ehr/resources/assets/images/etc.png"
                alt="기타 중고 물품"
                class="kategory"
              />
            ...
            <div class="kategoryWrap kategoryH">
              ...
              <a href="#"><strong>기타 중고 물품</strong></a>
    ...
    <!-- 캐러셀 js -->
    <script src="/ehr/resources/assets/js/main.js">
