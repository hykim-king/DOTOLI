...
public class EmailDaoJdbc implements EmailDao {
	...
	@Override
	public int doUpdate_Is_Registered(EmailVO inVO) throws SQLException {
		int flag = 0;
		StringBuilder sb = new StringBuilder(150);
		sb.append(" UPDATE email_auth         \n");
		sb.append("    SET is_registered = ?          \n");
		sb.append(" WHERE email = ?           \n");

		Object[] args = { inVO.getIs_Registered(), inVO.getEmail()};
	...
	@Override
	public int isExistsEmail(EmailVO inVO) throws SQLException {
		int flag = 0;
