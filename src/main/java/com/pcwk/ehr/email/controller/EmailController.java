...
public class EmailController {
	...
	@RequestMapping(value = "/email/send.do", method = RequestMethod.POST, produces = "application/json;charset=UTF-8")
	@ResponseBody
	public String sendAuthCode(@RequestBody EmailVO param) throws Exception {
		...
		log.info("Received email: {}", param.getEmail());
		log.info("isExistsEmail flag: {}", flag);
	...
	@RequestMapping(value = "/email/send_Login.do", method = RequestMethod.POST, produces = "application/json;charset=UTF-8")
	@ResponseBody
